...
let advantagesHTML = `
  <div class="advantages__header">
    <h1 class="advantages__headline" style="display: none;">${
      advantages.headerline
    }</h1>
  </div>
...
const policySelection = document.createElement("hr");
policySection.classList.add("policy__hr");
