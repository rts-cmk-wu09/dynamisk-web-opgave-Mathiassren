let hero = {
  ...
  let footers = {
    headliner: [
      {
        footerheadline: "Easy Camper",
        footertext: "When passion meets comfort.",
      },
    ],
    ...
    footerflex: [
      {
        ...
        linktext: ["Where to shop", "Tour Guided", "Our tours", "About us"],
      },
  
      {
        headline: "Become a Manager",
        linktext: ["Joining your pairing", "Offer your Service", "Are you a guide?"],
      },
  
      {
        headline: "Assistance",
        linktext: ["Support Center", "FAQs", "Cancallation Options", "Reliability and Sequrity"],
      },
    ],
    ...
    policy: [
      {
        ...
        linktext: ["About", "Site Map", "Terms", "Privacy Policy", "Teams"],
      },
    ],
  };